...
import type { SystemLogTerminalProps } from "../types/logging";
    ...
    <div className="flex flex-col h-full bg-zinc-950">
      <div className="flex items-center justify-between px-3 py-1.5 bg-zinc-900 border-b border-zinc-800 shrink-0">
        ...
        <div className="flex items-center gap-1.5">
          <button
            onClick={handleClear}
            className="px-2 py-0.5 rounded text-[11px] font-medium text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 transition-colors"
          >
            Clear
          </button>
          <button
